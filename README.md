...
static int color_for_item(char it){
    switch(it){
        ...
        case IT_M: return C_MAGENTA;  /* mandarine */
...
static void print_contract(Game *g){
    printf("Contrat: ");
    const char keys[ITEM_COUNT]={IT_S,IT_F,IT_P,IT_O,IT_M};
...
void display_board(Game *g, Player *p){
    ...
    printf("Niveau: %d  |  Vies: %d  |  Coups restants: %d  |  Temps restant: %d  |  Score niv.: %d  |  Total: %d\n",
